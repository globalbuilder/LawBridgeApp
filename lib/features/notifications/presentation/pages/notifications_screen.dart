  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<NotificationsBloc, NotificationsState>(
        builder: (_, state) {
          if (state.status == NotifStatus.loading) return const CustomLoader();
          if (state.status == NotifStatus.error && state.error != null) {
              ...
              itemBuilder: (_, i) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: () async {
                      // Navigate with a direct MaterialPageRoute and wait
